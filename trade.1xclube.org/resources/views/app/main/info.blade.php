...
<head>
  ...
  <meta content='Withdrawal Proof, You earn profit by funding in the cold drink project - ColdDrinkFund, You earn profit by funding in the cold drink project - ColdDrinkFund' name='keywords' />
  <meta property="article:tag" content="Withdrawal Proof, You earn profit by funding in the cold drink project - ColdDrinkFund" name='description' />
  <meta content="Withdrawal Proof, You earn profit by funding in the cold drink project - ColdDrinkFund" name='DC.title' />
  ...
  <link type="text/css" rel="stylesheet" href="/css/withdrawal-proof.css" />

  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
  <script type="text/javascript" src="/js/out.js"></script>
  <link type="text/css" rel="stylesheet" href="/css/resize.css" />
  <title>Withdrawal Proof, You earn profit by funding in this project - 1x Club</title>
</head>
...
<body>
  ...
  <div class="my_pbody">
    ...
    <div class="sv1_fix">
      ...
      <div class="sv1_fix_box  FixBProfile" style=""><a href="/mine" class="load2 minmr2 BtnPlay"><i></i><span>My Profile</span></a></div>
    </div>
    <!--FixBottomMenu--E-->
    <div class="my_pbody_in">
      ...
      <!-- <div class="my_aid"><span>User AID:</span>CD601E19EAB10</div> -->
      <!--Post--S-->
      <div id="data-container" style="padding-bottom: 50px;"></div>
      ...
      <!--FixSupport--S-->
      <div class="my_fix_icon">

        <a href="#" class="my_fix_icon1 tload1"><img src="/icon/rules4.png" />Rules</a>

        <a href="#" class="my_fix_icon2 tload1"><img src="/icon/upload.png" />Upload</a>
      </div>
      <!--FixSupport--E-->
    </div>
  </div>
  ...
  <script>
    $(document).ready(function () {
      ...
      function loadData() {
        ...
        loading = true;
        var action = 'WithdrawalProof';
        $.ajax({
          url: '__wproof_result_data.php',
          type: 'GET',
          data: {
            page: page,
            inno: inno,
      ...
      $('.my_pbody_in').scroll(function () {
        if ($('.my_pbody_in').scrollTop() + $('.my_pbody_in').height() >= $('#data-container').height() - 10) {
          loadData();
          // console.log($('#data-container').height());
  ...
  <script>
    /* $(document).on('click', '.minm_popup_close', function(){
						...
						var taburl = 'https://colddrinkfund.com/withdrawal-proof.php?rurl=aHR0cHM6Ly9jb2xkZHJpbmtmdW5kLmNvbS8=';
