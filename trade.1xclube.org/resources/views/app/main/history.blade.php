  ...
  <div class="my_pbody">
    ...
    <header class="my_thead">
      ...
      <section class="my_thead_b2">
        <h3 style="text-align: left;">Payment Records</h3>
      </section>
    </header>
    <!--FixBottomMenu--E-->
    <!-- <div class="sv1_fix">
    ...
    <div class="my_pbody_in my_record_result WithdrawalResult" style="top:0;">
        @php
            // Fetch all transactions, ordered by the newest first
            $transactions = class_exists('\App\Models\UserLedger') 
                ? \App\Models\UserLedger::where('user_id', auth()->id())->orderByDesc('id')->get() 
                : collect();
        @endphp
            ...
            <div class="my_record_b1">
              <div class="my_record_amount">
                <div class="my_record_amount_b2">
                  <div class="my_record_amount_t5">{{ $item->reason }}</div>
                  <div class="my_record_amount_t6">{{ ucfirst($item->status) }}</div>
                </div>
                <div class="my_record_amount_b1">
                  <h2 class="" style="color:#4caf50;">+ <i class="fa-solid fa-indian-rupee-sign"></i>{{ price($item->amount) }}</h2>
                </div>
              </div>
            </div>
