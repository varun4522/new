...
<head>
  ...
  <meta content='Change Password., You earn profit by funding in the cold drink project - ColdDrinkFund, You earn profit by funding in the cold drink project - ColdDrinkFund' name='keywords' />
  <meta property="article:tag" content="Change Password., You earn profit by funding in the cold drink project - ColdDrinkFund" name='description' />
  <meta content="Change Password., You earn profit by funding in the cold drink project - ColdDrinkFund" name='DC.title' />
  ...
  <title>Change Password., You earn profit by funding in this project - 1x Club Fund</title>
</head>
  ...
  <div class="my_pbody">
      ...
      <div class="my_menu_tab">
        ...
        <div class="my_menu_b2">
          <a href="./" class=" load3 minmr2"><span style="color:;"><i class="fa fa-home"></i></span>
            ...
            <h2>My Friends</h2>
            <dl><em class="fa-solid fa-angle-right"></em></dl>
          </a><a href="./bank-account-update.php?rurl=aHR0cHM6Ly9jb2xkZHJpbmtmdW5kLmNvbS9jaGFuZ2UtcGFzc3dvcmQucGhw" class=" load3 minmr2"><span style="color:;"><i class="ri-bank-card-fill"></i></span>
            <h2>Update Bank</h2>
            <dl><em class="fa-solid fa-angle-right"></em></dl>
    ...
    <div class="my_pbody_in" style="bottom: 0;">
      ...
      <div class="my_form">
        ...
        <div class="my_form_in">
          ...
          <section><small id="userPassTxt">Current Password</small>
            <aside><span><i class="fa-solid fa-lock"></i></span><input name="current_password" type="password" placeholder="*Enter current password" value="" autofocus autocomplete="off" id="userePass" /><abbr class="pPassShow"><i class="fa-regular fa-eye-slash"></i></abbr></aside>
          </section>
          
          <section><small id="userPassTxt">New Password</small>
            <aside><span><i class="fa-solid fa-lock"></i></span><input name="new_password" type="password" placeholder="*Enter new password" value="" autofocus autocomplete="off" id="userPass" /><abbr class="pPassShow"><i class="fa-regular fa-eye-slash"></i></abbr></aside>
          </section>

          <section><small id="userPassTxt">Confirm New Password</small>
            <aside><span><i class="fa-solid fa-lock"></i></span><input name="confirm_password" type="password" placeholder="*Confirm new password" value="" autofocus autocomplete="off" id="userPass2" /><abbr class="pPassShow2"><i class="fa-regular fa-eye-slash"></i></abbr></aside>
          </section>

          <!--<section class="myCaptcha"><small>Captcha Code</small>-->
          <!--  <aside><span><i class="fa-solid fa-spell-check"></i></span>-->
          <!--    <em class="fa-solid fa-arrows-rotate captcha-image2"></em><input type="text" placeholder="*Type captcha code" maxlength="4" value="" autofocus autocomplete="off" id="CaptchaCode2" />-->
          <!--    <img style="width:35%; height:37px;" src="./inc/captcha_code.php?1759910553" alt="CAPTCHA" class="captcha-image" />-->
          <!--  </aside>-->
          <!--</section>-->

          <div class="my_form_btn" style="position: relative; padding: 0;"><button type="submit" id="PasswordModify" class="BtnPlay"><i class="ri-checkbox-circle-fill"></i> UPDATE</button></div>
        </div>
    ...
    <script>
      /* $(document).on('click', '.minm_popup_close', function(){
						...
						var taburl = 'https://colddrinkfund.com/change-password.php';
