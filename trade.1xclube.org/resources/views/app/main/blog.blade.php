...
<head>
  ...
  <meta content='Frequently & Questions?, You earn profit by funding in the cold drink project - ColdDrinkFund, You earn profit by funding in the cold drink project - ColdDrinkFund' name='keywords' />
  <meta property="article:tag" content="Frequently & Questions?, You earn profit by funding in the cold drink project - ColdDrinkFund" name='description' />
  <meta content="Frequently & Questions?, You earn profit by funding in the cold drink project - ColdDrinkFund" name='DC.title' />
  ...
  <title>Frequently & Questions?, You earn profit by funding in this project - 1x Club</title>
</head>
...
<body>
  ...
  <div class="my_pbody">
    ...
    <div class="my_pbody_in" style="bottom: 0;">
      ...
      <header class="my_thead">
        ...
        <section class="my_thead_b3">
          <div class="my_thead_icon">
          </div>
        </section>
      </header>
      <!--F&Q--S-->
      <div class="se_faq">
        <div class="se_faq_box">
          <dt>How to earn profit in 1x Club?<em class="ri-arrow-right-s-line"></em></dt>
          <dd><b>1x Club</b> is a very easy and simple digital platform where you can earn without any risk.
            <br /><br />
            1x Club is a platform where you can earn good profit without any digital knowledge and it is a risk free digital platform.
            <br /><br />
            Even if you do not know how to digital work, you can still earn good profit here on a daily basis.
          </dd>
        </div>
        <div class="se_faq_box">
          <dt>How to place a order in 1x Club?<em class="ri-arrow-right-s-line"></em></dt>
          <dd>Go to Order Plans section and select suitable product and place order.
            <br /><br />
            You can place order with minimum ₹100 and maximum ₹150500.
            <br /><br />
            After placing the product go to the my order section and you will be able to collect profit every 24 hours.
          </dd>
        </div>
        <div class="se_faq_box">
          <dt>Will my investment amount be refunded or is there any locking period?<em class="ri-arrow-right-s-line"></em></dt>
          <dd>No, there is no locking period and the investment amount will not be returned. You have been given more validity.</dd>
        </div>
        <div class="se_faq_box">
          <dt>When does the payment arrive after withdrawal?<em class="ri-arrow-right-s-line"></em></dt>
          <dd>Withdrawals will credited to the account within 1 hour to 24 hours.</dd>
        </div>
        <div class="se_faq_box">
          <dt>Why the withdrawal rejected?<em class="ri-arrow-right-s-line"></em></dt>
          <dd>When you apply for withdrawal, the system will automatically verify the bank account you filled with our cooperative bank to ensure that you withdrawal can be safely received by you.
            <br /><br />
            Once the system finds that the bank account information you have filled in incorrect, the system will automatically your withdrawal request rejected.
            <br /><br />
            If you encounter such problems, you can first check your user and bank account information. If there are any errors, Please correct them immediately before withdrawing them. If you are sure that all information is correct, Please immediately chat with online customer service for help.
          </dd>
        </div>
        <div class="se_faq_box">
          <dt>What is the requirements on your withdrawal?<em class="ri-arrow-right-s-line"></em></dt>
          <dd>You can add your bank account on the app to withdraw cash.
            <br />Withdrawal hours are monday to fridy from 10:00 AM to 08:00 PM.
          </dd>
        </div>
        <div class="se_faq_box">
          <dt>What is Minimum withdrawal?<em class="ri-arrow-right-s-line"></em></dt>
          <dd>Our minimum withdrawal is <i class="fa-solid fa-indian-rupee-sign"></i>150.</dd>
        </div>
        <div class="se_faq_box">
          <dt>Am i able to withdrawal deposit?<em class="ri-arrow-right-s-line"></em></dt>
          <dd>Yes!, You can withdrawal when your earning balance reaches the minimum withdrawal is <i class="fa-solid fa-indian-rupee-sign"></i>150.</dd>
        </div>
        <div class="se_faq_box">
          <dt>If I deposit an amount of money into wallet balance, can i withdraw it?<em class="ri-arrow-right-s-line"></em></dt>
          <dd>Yes!, The wallet balance reached minimum withdrawal balance <i class="fa-solid fa-indian-rupee-sign"></i>150.</dd>
        </div>
        <div class="se_faq_box">
          <dt>What is referral income?<em class="ri-arrow-right-s-line"></em></dt>
          <dd>When you refer a friend to join 1x Club, you will get ₹50 bonus on successful joining of new member and buying minimum ₹100 task from among the options. Earn 20% commission on your direct referrals investments and next Earn 3% commission on Level 2 referrals (friends of your friends) and next Earn 1% commission on Level 3 referrals (extended network).</dd>
        </div>
        <div class="se_faq_box">
          <dt>How to get referral bonus?<em class="ri-arrow-right-s-line"></em></dt>
          <dd>Go to my friends section check Invite Mission information If your Receive btn is enable or color button. Then you click button to get income your Wallet.</dd>
        </div>
        <div class="se_faq_box">
          <dt>What is the referral income?<em class="ri-arrow-right-s-line"></em></dt>
          <dd>There are upto 3 levels in a team by referral joining by member.<br />
            Invite your friends to join now! you will get 20% of total the item purchased just share the link below<br /><br />
            <li>1. 20% from 1st level joined members.</li>
            <li>2. 3% from 2nd level joined members.</li>
            <li>3. 1% from 3rd level joined members.</li>
            <br /><br />
            <strong>Note:</strong> The referral income is only available for the members who have purchased the task from the referral link shared by the referrer. If the member does not purchase any task, then no referral income will be generated.
          </dd>
        </div>
      </div>
    ...
    <script>
      ...
      //     $('.se_faq dd').hide();
      //     $('.se_faq dt').hover(function(){$(this).addClass('hover')},function(){$(this).removeClass('hover')}).click(function(){
    ...
    <script>
      /* $(document).on('click', '.minm_popup_close', function(){
						...
						var taburl = 'https://colddrinkfund.com/frequently-a-questions.php';
