...
// Games data
$games = [
    ['link' => 'games.html', 'name' => 'Chicken Road', 'logo' => 'https://chickentoroad.com/icon.jpeg', 'category' => 'Adventure', 'popularity' => 92, 'featured' => true, 'jackpot' => 300000],
    ['link' => 'aviator.php', 'name' => 'Trading', 'logo' => 'https://i.ibb.co/rGNkj64g/Screenshot-20250802-045115.png', 'category' => 'Crypto', 'popularity' => 98, 'featured' => true, 'jackpot' => 500000],
    ['link' => 'mines.php', 'name' => 'Diamond Mines', 'logo' => 'https://www.softswiss.com/wp-content/uploads/2023/12/Turbo_Mines-1.png', 'category' => 'Strategy', 'popularity' => 94, 'featured' => true, 'jackpot' => 750000],
];

// Games data with direct links
$games = [
    [
        'link' => 'chicken-road.php',
        'name' => 'Chicken Road',
        'logo' => 'https://chickentoroad.com/icon.jpeg',
        'category' => 'Adventure',
        'popularity' => 92,
        'featured' => true,
        'jackpot' => 300000
    ...
    [
        'link' => 'aviator.php',
        'name' => 'Trading',
        'logo' => 'https://i.ibb.co/rGNkj64g/Screenshot-20250802-045115.png',
        'category' => 'Crypto',
        'popularity' => 98,
        'featured' => true,
        'jackpot' => 500000
    ...
    [
        'link' => 'Hilo.php',
        'name' => 'Hilo Games',
        'logo' => 'https://tse3.mm.bing.net/th/id/OIP.K253li_MA4yJzp88eYgxTgHaHa?w=512&h=512&rs=1&pid=ImgDetMain&o=7&rm=3',
        'category' => 'Adventure',
        'popularity' => 92,
        'featured' => true,
        'jackpot' => 300000
    ...
    [
        'link' => 'coin.php',
        'name' => 'Coin Flip',
        'logo' => 'https://client.qtlauncher.com/images/?id=GLX-coinflip_en_US&type=logo-square&version=1695782766531',
        'category' => 'Rummy',
        'popularity' => 96,
        'featured' => true,
        'jackpot' => 1250000
    ...
    [
        'link' => 'andar.php',
        'name' => 'Andar Bahar',
        'logo' => 'https://play-lh.googleusercontent.com/4j8fpqETFQX8sWkONyuT_YMWx0Rr-rJufZMTqOb8s2piHxF1u639PClL3xTgLqA9DRY',
        'category' => 'Casiono',
        'popularity' => 94,
        'featured' => true,
        'jackpot' => 750000
    ...
    [
        ...
        'logo' => 'https://i.pinimg.com/originals/92/0c/3d/920c3d205ed0fe2aca5368d74cde35c9.jpg',
        'category' => 'Crash',
        'popularity' => 98,
        'featured' => true,
        'jackpot' => 500000
    ...
    [
        'link' => 'mines.php',
        'name' => 'Diamond Mines',
        'logo' => 'https://www.softswiss.com/wp-content/uploads/2023/12/Turbo_Mines-1.png',
        'category' => 'Strategy',
        'popularity' => 94,
        'featured' => true,
        'jackpot' => 750000
...
$activities = [
    ...
    ['icon' => 'fa-bell', 'text' => 'New game available: Chicken Road Deluxe', 'time' => '1 hour ago', 'color' => 'text-purple-400'],
...
<head>
  ...
  <title>Chicken Road Game - Premium Gaming Platform</title>
...
<body class="gradient-bg min-h-screen overflow-x-hidden">
  ...
  <div class="welcome-popup animate__animated animate__fadeIn">
    <div class="welcome-content glass-effect">
      <div class="relative">
        <img src="https://img.freepik.com/premium-photo/neon-welcome-lettering-textured-background_317169-2142.jpg" alt="Welcome to Chicken Road" class="w-full h-40 object-cover">
        <div class="absolute top-0 left-0 right-0 bottom-0 bg-gradient-to-t from-black to-transparent"></div>
        <div class="absolute bottom-4 left-4">
          <h2 class="text-2xl font-bold text-white">Welcome to Chicken Road!</h2>
    ...
    <div class="container mx-auto px-4 py-3 flex justify-between items-center">
      <div class="flex items-center space-x-2">
        <div class="logo-container w-10 h-10">
          <img src="images/REG.jpg" alt="Chicken Road Logo" class="logo-img">
        </div>
      ...
      <div class="flex items-center space-x-4">
        <div class="relative">
          <button onclick="toggleNotifications()" class="w-10 h-10 flex items-center justify-center rounded-full bg-white/5 hover:bg-white/10 transition-colors touch-feedback">
      ...
      <div class="glass-effect rounded-xl p-4 card-3d">
        ...
        <div class="mb-2">
          ...
          <div class="xp-progress">
            <div class="xp-progress-fill" style="width: <?= $userXP ?>%"></div>
          </div>
        </div>
        ...
        <div class="swiper-wrapper">
          ...
          if(!isset($winners) || !is_array($winners)) {
            $winners = [
              ...
              ['name' => 'Vikram Das', 'amount' => 88000, 'game' => 'Chicken Road', 'avatar' => './avatar/5.png'],
            ];
          }
  ...
  <script>
    ...
    function claimWelcomeBonus() {
      ...
      // Update balance (in a real app, this would be an AJAX call)
      const balanceElement = document.querySelector('.fa-coins')?.nextElementSibling;
      if(balanceElement) {
        const currentBalance = parseInt(balanceElement.textContent.replace(/[^0-9]/g, '')) || 0;
        const bonusAmount = Math.floor(currentBalance * 2); // 200% bonus for demo
        const newBalance = currentBalance + bonusAmount;
        balanceElement.textContent = '₹' + newBalance.toLocaleString();
      }
      
      // Show success message
      showToast('🎉 Welcome bonus claimed! +₹' + bonusAmount.toLocaleString());
    }
    ...
    function showToast(message) {
      ...
      toast.className = 'fixed bottom-20 left-1/2 transform -translate-x-1/2 bg-indigo-600 text-white px-4 py-2 rounded-lg shadow-lg z-50 animate__animated animate__fadeInUp';
    ...
    // Initialize terms checkbox event
    document.getElementById('termsCheckbox').addEventListener('change', checkDepositButton);
    document.getElementById('depositAmount').addEventListener('input', checkDepositButton);
    ...
    setInterval(() => {
      const balanceElement = document.querySelector('.fa-coins')?.nextElementSibling;
      if(balanceElement && Math.random() > 0.7) { // 30% chance of balance change
        const currentBalance = parseInt(balanceElement.textContent.replace(/[^0-9]/g, '')) || 0;
        const change = Math.floor(Math.random() * 100) - 45; // Random change between -45 and +54
        const newBalance = Math.max(0, currentBalance + change);
        balanceElement.textContent = '₹' + newBalance.toLocaleString();
        
        if(change > 0) {
          showToast(`💰 +₹${change} from gameplay!`);
        }
      }
    }, 10000);
    ...
    // Simulate XP gain
    setInterval(() => {
      if(Math.random() > 0.8) { // 20% chance of XP gain
        const xpFill = document.querySelector('.xp-progress-fill');
        const currentXP = <?= $userXP ?>;
        const newXP = Math.min(100, currentXP + 5);
        xpFill.style.width = `${newXP}%`;
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      // Enable deposit button when terms are checked
      document.getElementById('termsCheckbox').addEventListener('change', function() {
        checkDepositButton();
      });
      
      // Check deposit amount input
