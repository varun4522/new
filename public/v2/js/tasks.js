layui.use(function(){
    ...
    $.post('/api/user/team',{},function (res) {
        var data = res.result;
        var TasksRewardTpl = document.getElementById('TasksRewardTpl').innerHTML;
        var TasksRewardView = document.getElementById('tasks_reward_text_card');
        ...
        laytpl(TasksRewardTpl).render(data, function(str){
            TasksRewardView.innerHTML = str;
        });
