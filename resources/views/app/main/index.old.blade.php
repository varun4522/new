      ...
      <div class="container">
        ...
        <div id="telegramPopup" class="popup-overlay">
          <div class="popup-content">
            ...
            <a href="https://t.me/+6haLX96eZNw0OTE1" target="_blank" class="telegram-btn">
        ...
        <!-- Floating Action Button -->
        <a href="https://t.me/+6haLX96eZNw0OTE1" class="fab" target="_blank">
    ...
    <script type="text/javascript">
      ...
      document.addEventListener('DOMContentLoaded', function () {
        ...
        document.getElementById('telegramBtn').addEventListener('click', function () {
          window.open('https://t.me/+6haLX96eZNw0OTE1', '_blank');
        });
      });
