...
<head>
  ...
  <meta content='Raise a Ticket?, You earn profit by funding in the cold drink project - ColdDrinkFund, You earn profit by funding in the cold drink project - ColdDrinkFund' name='keywords' />
  <meta property="article:tag" content="Raise a Ticket?, You earn profit by funding in the cold drink project - ColdDrinkFund" name='description' />
  <meta content="Raise a Ticket?, You earn profit by funding in the cold drink project - ColdDrinkFund" name='DC.title' />
  ...
  <link type="text/css" rel="stylesheet" href="/css/raise-a-ticket.css" />

  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
  <script type="text/javascript" src="/js/out.js"></script>
  <link type="text/css" rel="stylesheet" href="/css/resize.css" />
  <title>Raise a Ticket?, You earn profit by funding in this project - 1x Club</title>
</head>
  ...
  <div class="my_pbody">
    ...
    <div class="my_pbody_in" style="bottom: 0;">
      ...
      <header class="my_thead">
        ...
        <section class="my_thead_b3">
          <div class="my_thead_icon">
            <dl>
              <a href="#" anim="minmr" class="ShowComplaintRecord tload1">
      ...
      <div class="my_form">
        <div class="my_form_in">
          ...
          <section><small>Complaint Subject</small>
            <aside><span><i class="fa-solid fa-circle-right"></i></span>
              <select id="SelectIssu">
                ...
                <option value="Referral related">Referral related</option>
                <option value="Others">Others</option>
              </select>
            </aside>
          </section>

          <section><small>Your msg</small>
            <aside><span><i class="fa-solid fa-pen-to-square"></i></span>
              <textarea placeholder="Type your message..." maxlength="100" id="Msg" autofocus autocomplete="off"></textarea>
            </aside>
          </section>

          <section class="myCaptcha"><small>Captcha Code</small>
            <aside><span><i class="fa-solid fa-spell-check"></i></span><em class="fa-solid fa-arrows-rotate captcha-image2"></em><input type="text" placeholder="*Type captcha code" maxlength="4" value="" autofocus autocomplete="off" id="CaptchaCode2"><img style="width:35%; height:37px;" src="./inc/captcha_code.php?1759650388" alt="CAPTCHA" class="captcha-image" /></aside>
          </section>

          <div class="my_form_btn"><button id="ComplaintSubmit" class="BtnPlay"><i class="ri-checkbox-circle-fill"></i> SUBMIT</button></div>
    ...
    <script>
      ...
      function ComplaintRecord() {
        var action = 'ComplaintRecord';
        $('.ComplaintResult').html('<div class="load5"></div>');
        $.post('./__record_history.php', {
          action: action
        }, function (data) {
          $('.ComplaintResult').html(data);
        });
      }
      $(document).on('click', '.ShowComplaintRecord', function () {
        ComplaintRecord();
      });
    </script>
    <!--Java--E-->
    ...
    <script>
      /* $(document).on('click', '.minm_popup_close', function(){
						...
						var taburl = 'https://colddrinkfund.com/raise-a-ticket.php';
